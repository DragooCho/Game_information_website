...
imgHover1.addEventListener("mouseover", () => {
  mainCardImg.style.backgroundImage =
    "url(https://raw.githubusercontent.com/DragooCho/TIL/main/image/image_015.jpg)";
  mainCardTextNode.innerText = "메탈릭 차일드 올 여름 닌텐도 스위치로";
});
imgHover2.addEventListener("mouseover", () => {
  mainCardImg.style.backgroundImage =
    "url(https://raw.githubusercontent.com/DragooCho/TIL/main/image/image_020.jpg)";
  mainCardTextNode.innerText = "모바일 RPG '제2의 나라' TV광고 공개";
});
imgHover3.addEventListener("mouseover", () => {
  mainCardImg.style.backgroundImage =
    "url(https://raw.githubusercontent.com/DragooCho/TIL/main/image/image_021.jpg)";
  mainCardTextNode.innerText = "턴제 전략 RPG '로스트 아이돌론' 소개";
});
imgHover4.addEventListener("mouseover", () => {
  mainCardImg.style.backgroundImage =
    "url(https://raw.githubusercontent.com/DragooCho/TIL/main/image/image_022.jpg)";
  mainCardTextNode.innerText = "닌자 가이덴: 마스터 콜렉션";
});
imgHover5.addEventListener("mouseover", () => {
  mainCardImg.style.backgroundImage =
    "url(https://raw.githubusercontent.com/DragooCho/TIL/main/image/image_016.jpg)";
  mainCardTextNode.innerText = "닌자 거북이: 슈레더의 복수";
});
imgHover6.addEventListener("mouseover", () => {
  mainCardImg.style.backgroundImage =
    "url(https://raw.githubusercontent.com/DragooCho/TIL/main/image/image_017.jpg)";
  mainCardTextNode.innerText = "'더 하우스 오브 더 데드: 리메이크' 공개";
});
imgHover7.addEventListener("mouseover", () => {
  mainCardImg.style.backgroundImage =
    "url(https://raw.githubusercontent.com/DragooCho/TIL/main/image/image_019.jpg)";
  mainCardTextNode.innerText = "사이버펑크 2077, ‘핫픽스 1.21’ 배포 실시";
});
imgHover8.addEventListener("mouseover", () => {
  mainCardImg.style.backgroundImage =
    "url(https://raw.githubusercontent.com/DragooCho/TIL/main/image/image_018.jpg)";
